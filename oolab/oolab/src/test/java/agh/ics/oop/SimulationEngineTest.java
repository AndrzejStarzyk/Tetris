...
class SimulationEngineTest {
    ...
    public void runTest(){
        ...
        final MoveDirection[] directions = new OptionsParser().parse(list1);
        ...
        final MoveDirection[] directions1 = new OptionsParser().parse(list2);
