...
class SimulationEngineTest {
    ...
    @Test
    public void runTest(){
        final IWorldMap testMap = new RectangularMap(5, 10);
        ...
        final IWorldMap testMap1 = new RectangularMap(5, 10);
        ...
        final MoveDirection[] directions1 = new OptionsParser().parse(new String[]{"for", "B",
                "f", "f",
                "f", "f",
                "r", "r",
                "f", "f",
